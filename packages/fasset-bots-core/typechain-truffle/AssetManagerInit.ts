  ...
  init: {
    (
      ...
      _settings: {
        ...
        __minUnderlyingBackingBIPS: number | BN | string;
        ...
        __redemptionDefaultFactorPoolBIPS: number | BN | string;
        ...
        poolExitCRChangeTimelockSeconds: number | BN | string;
        ...
        __cancelCollateralReservationAfterSeconds: number | BN | string;
        __rejectOrCancelCollateralReservationReturnFactorBIPS:
          | number
          | BN
          | string;
        __rejectRedemptionRequestWindowSeconds: number | BN | string;
        __takeOverRedemptionRequestWindowSeconds: number | BN | string;
        __rejectedRedemptionDefaultFactorVaultCollateralBIPS:
          | number
          | BN
          | string;
        __rejectedRedemptionDefaultFactorPoolBIPS: number | BN | string;
      },
