...
export interface GovernanceSettingsMockContract
  extends Truffle.Contract<GovernanceSettingsMockInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<GovernanceSettingsMockInstance>;
}
...
export interface GovernanceSettingsMockInstance
