...
export interface CoreVaultClientFacetContract
  extends Truffle.Contract<CoreVaultClientFacetInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<CoreVaultClientFacetInstance>;
}
...
export interface CoreVaultClientFacetInstance extends Truffle.ContractInstance {
