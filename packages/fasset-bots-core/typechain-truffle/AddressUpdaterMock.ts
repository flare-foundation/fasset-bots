...
export interface AddressUpdaterMockContract
  extends Truffle.Contract<AddressUpdaterMockInstance> {
  "new"(
    _governanceSettings: string,
    _initialGovernance: string,
    meta?: Truffle.TransactionDetails
  ): Promise<AddressUpdaterMockInstance>;
}
...
export interface AddressUpdaterMockInstance extends Truffle.ContractInstance {
