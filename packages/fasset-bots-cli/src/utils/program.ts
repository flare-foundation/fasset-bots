import { loadConfigFile } from "@flarenetwork/fasset-bots-core/config";
import { programVersion, resolveInFassetBotsCore, stripIndent } from "@flarenetwork/fasset-bots-core/utils";
