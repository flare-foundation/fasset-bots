import { NotificationLevel, RateLimitOptions } from "@flarenetwork/fasset-bots-common";
...
export interface WalletNotifier {
    send(source: string | null, level: NotificationLevel, key: WalletNotificationKey, message: string): Promise<void>;
}
